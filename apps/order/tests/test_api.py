...
#         self.assertEqual(self.product, order.order_items.first().product)
#         self.assertEqual(expected_data, str(order.order_items.first()))
#         self.assertEqual(self.user, order.owner)
#         self.assertEqual(CASH, order.buying_type)
#         self.assertEqual(2, orders_before_creating)
