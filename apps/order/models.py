...
class OrderItem(models.Model):
    ...
    """
    owner = models.ForeignKey(User, verbose_name='Владелец купленного товара', blank=True, null=True,
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена товара за штуку')
    ...
    def __str__(self):
        return f'Заказ для {self.product.title} продукта \
                    от {self.order.first_name} {self.order.last_name}'
